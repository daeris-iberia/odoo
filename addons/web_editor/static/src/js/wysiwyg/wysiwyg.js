...
const Wysiwyg = Widget.extend({
    ...
    _getCommands: function () {
        ...
        const commands = [
            {
                groupName: _t('Bloques básicos'),
                title: _t('Citas'),
                description: _t('Agrega una sección de citas.'),
            ...
            },
            {
                groupName: _t('Bloques básicos'),
                title: _t('Código'),
                description: _t('Agrega una sección de código.'),
                fontawesome: 'fa-code',
                callback: () => {
            ...
            {
                groupName: _t('Navegación'),
                title: _t('Enlace'),
                description: _t('Agrega un enlace.'),
                fontawesome: 'fa-link',
                callback: () => {
            ...
            },
            {
                groupName: _t('Navegación'),
                title: _t('Botón'),
                description: _t('Agrega un botón.'),
                fontawesome: 'fa-link',
                callback: () => {
                    this.toggleLinkTools({forceDialog: true});
        ...
        if (options.isInternalUser) {
            commands.push({
                groupName: _t('Medios'),
                title: _t('Imagen'),
                description: _t('Inserta una imagen.'),
        ...
        if (options.allowCommandVideo) {
            commands.push({
                groupName: _t('Medios'),
                title: _t('Video'),
                description: _t('Inserta un vídeo.'),
