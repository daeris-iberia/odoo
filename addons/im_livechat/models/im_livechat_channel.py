...
class ImLivechatChannel(models.Model):
    ...
    button_text = fields.Char('Text of the Button', default=_('¿Tienes una pregunta? Chatea con nosotros.'),
        help="Default text displayed on the Livechat Support Button")
    default_message = fields.Char('Welcome Message', default='¿Hola, como puedo ayudarte?',
    ...
    header_background_color = fields.Char(default="#0874AA", help="Default background color of the channel header once open")
